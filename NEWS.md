...
* Implements `test_t1()`: reliability-independent test of structural interpretation
  (Section 3.3 of VanderWeele & Vansteelandt, 2022).
* Implements `estimate_reliability()`: estimation of reliability coefficients via
  quasi-Poisson GLM on pairwise covariances (Section 3.1).
