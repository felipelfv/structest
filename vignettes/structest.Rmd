...
freedom. The test requires estimated reliability coefficients $\lambda_i$,
...
Preferred over $T_0$ because it does not rely on distributional assumptions
...
log-reliabilities. The function fits this as a quasi-Poisson GLM with log
link.
...
- **$T_1$ is generally preferred** because it does not depend on the
  distributional assumptions needed to estimate reliabilities (e.g.,
...
Statistical Society: Series B (Statistical Methodology)*, 84, 1063--1089.
