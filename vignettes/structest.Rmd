...
(Following the paper, we use the term "reliabilities" for $\lambda_i$;
in mainstream psychometrics these are more commonly known as factor loadings.)
...
formalise it using generalised methods of moments estimators
(Newey & McFadden, 1994).
...
rank constraint using generalised methods of moments, with $d \times p$
